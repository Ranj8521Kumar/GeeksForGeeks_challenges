...
# 🧠 GeeksForGeeks DSA Challenges

[![Problems Solved](https://img.shields.io/badge/Problems%20Solved-141-brightgreen?style=for-the-badge)](https://www.geeksforgeeks.org/)
[![Language](https://img.shields.io/badge/Language-C%2B%2B%20%7C%20Python-blue?style=for-the-badge&logo=cplusplus)](https://isocpp.org/)
...
*A curated collection of Data Structures & Algorithms solutions organized by difficulty level.*
...
This repository contains my personal solutions to **GeeksforGeeks** DSA problems. Each solution is written in **C++** or **Python** and is accompanied by the original problem statement. Problems are organized into four difficulty levels: **Basic**, **Easy**, **Medium**, and **Hard**.

> Auto-synced using [GfG To GitHub](https://github.com/AtharvaNanavate/GfG-To-GitHub)
...
- **Solution file** (`.cpp` or `.py`) — the actual implementation
- **README.md** — the full problem statement, examples, constraints, company tags, and topic tags from GeeksForGeeks
...
1. **Browse by difficulty** — Use the sections above to find problems at your skill level.
2. **Open a problem folder** — Each folder contains the problem statement (`README.md`) and the solution file.
3. **Read the problem** — The `README.md` inside each folder has the full GfG problem description, examples, and constraints.
4. **Study the solution** — Open the `.cpp` or `.py` file to see the implementation.
...
- 🌐 [GeeksForGeeks](https://www.geeksforgeeks.org/) — Practice Platform
- 🔧 [GfG To GitHub](https://github.com/AtharvaNanavate/GfG-To-GitHub) — Auto-sync extension used to push solutions
